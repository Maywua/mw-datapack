...
# 技能施放动画
function mw:weapons/long_sword/skills/0/animation/summon_stage2

# scoreboard players set $strength player_motion.api.launch 500
# function player_motion:api/launch_looking

scoreboard players set @s ls_s0_cooldown_timer 10

scoreboard players reset @s ls_s0_recast_timer